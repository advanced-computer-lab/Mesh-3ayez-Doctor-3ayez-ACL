...
export default function FlightForm() {
    ...
    return (
        <Container style={{ width: "693px", margin: "auto", marginTop: "100px", height: "500px" }}>
            <Paper elevation={2}  >

                <div style={{ margin: "auto", backgroundColor: colors.c1, width: "640px", height: "80px", textAlign: "center", boxShadow: "px #999999" }}>
                ...
                <Box
                    ...
                    width="600px"
                    padding="20px"
                    style={{ borderRaduis: "10%", boxShadow: "2px auto #999999" }}
                ...
                /> */}
                    ...
                    <Stack direction="row" spacing={1} >
                        <Button style={{
                            ...
                            borderRadius: 5,
                            color: colors.c1,
                            marginTop: "25px", margin: "auto"
                        }} variant="outlined" href="/admin">Back </Button>
                        <Button style={{
                            textAlign: "center", marginLeft: "auto",
                            borderRadius: 5,
                            backgroundColor: colors.c1,
                            marginTop: "25px", margin: "auto"
                        }} variant="contained" onClick={onSubmit} href="/createFlight">Submit </Button>
